...
// Last update Wed May 22 04:50:55 2013 julien fortin
//
...
namespace Input
{
  ...
  void	InputManager::init()
  {
    ...
    // InputManager::getInputManager()->_inputThread =
    //   new BomberMan::Unix::UnixThread(0, &_startInputGetter, 0, 0);
    //InputManager::getInputManager()->getInput();


    /*

      Tous mettre dans le meme thread et test chaque seconde pour la detection.
      Verifier le temps avec un time et pas refaire de scan a chaque debloquement du select
     */
  }
